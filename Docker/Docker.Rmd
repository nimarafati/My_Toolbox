---
title: "Packaging and sharing data science applications as Docker container images"
subtitle: 'Swedish Bioinformatics Workshop 2024' 
author: "Nima Rafati"
date: "2024-11-05"
output: md_document
format: 
...
Clone the github repo developed for a project at ScilifeLab on survey for people with ADHD diagnoses (age 0-19) that use medications in 2006.  The dataset is from _The Swedish National Board of Health and Welfare (Socialstyrelsen)_. 
```{bash, eval = F}
